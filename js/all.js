(function($){
    ...
    var pageSection = $(".page-section, .small-section, .split-section");
    ...
    $(window).on("resize", function() {
        if ($(window).width() <= 768) {
          pageSection2.css("background-image", "url(images/full-width-images/bg-rp.png)");
        } else {
          pageSection2.css("background-image", function() {
      ...
      window.addEventListener('resize', function(){
        ...
        if (window.innerWidth >= 769) {
            homeSection.style.backgroundPosition = "70% 0";
        } else {
            homeSection.style.backgroundPosition = "0 0";
        }
    });
